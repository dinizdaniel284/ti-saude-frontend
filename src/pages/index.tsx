...
import AdBanner from "../components/AdBanner"; // ✅ ADSENSE
        ...
        <section className="relative bg-[#020617] py-24 lg:py-40 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="relative mt-20 p-8 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-xl">
              <p className="text-center text-slate-500 text-[10px] font-black uppercase tracking-[0.5em] mb-10">
                Stack Tecnológica & Protocolos
              </p>
              <CarouselHome />
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
              <div className="max-w-xl">
                ...
                <p className="text-slate-500 text-lg">
                  Insights técnicos sobre arquitetura, dados e inovação clínica.
                </p>
              </div>
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                {posts.map((post, i) => (
                  <Link key={i} href={post.link} className="group">
                    <article className="relative bg-white h-full rounded-[2.5rem] p-8 border border-slate-200 transition-all duration-500 hover:shadow-xl hover:-translate-y-3 overflow-hidden">
